jQuery(document).ready(function () {
    ...
    {
        jQuery("html, .menu-wraper").niceScroll({cursorcolor: "#b1b1b1", scrollspeed: 100, smoothscroll: false, mousescrollstep: 80, cursorwidth: "12px", cursorborder: "none", cursorborderradius: "0px"});
    ...
    jQuery("a[rel^='prettyPhoto']").prettyPhoto({
        ...
        callback: function () {
            if (!is_touch_device()) {
                ...
                if (!(ua.indexOf("safari/") !== -1 && ua.indexOf("windows") !== -1 && ua.indexOf("chrom") === -1))
                {
                    jQuery("html").niceScroll({cursorcolor: "#b1b1b1", scrollspeed: 100, smoothscroll: false, mousescrollstep: 80, cursorwidth: "12px", cursorborder: "none", cursorborderradius: "0px"});
                }
            }
        }
    });
        ...
        } else
        {
            jQuery('.menu-wraper').fadeOut(function () {
                ...
                if (!is_touch_device()) {
                    ...
                    if (!(ua.indexOf("safari/") !== -1 && ua.indexOf("windows") !== -1 && ua.indexOf("chrom") === -1))
                    {
                        jQuery("html").niceScroll({cursorcolor: "#CDC8C1", scrollspeed: 100, smoothscroll: false, mousescrollstep: 80, cursorwidth: "12px", cursorborder: "none", cursorborderradius: "0px"});
                    }
                } else
                {
